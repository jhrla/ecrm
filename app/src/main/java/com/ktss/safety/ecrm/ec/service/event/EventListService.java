...
import com.ktss.safety.ecrm.ec.mapper.event.EventListMapper;
...
public class EventListService {
    ...
    public Map<String, Object> getEventList(Map<String, Object> paramMap) {
        ...
        List<Map<String, Object>> resultList = eventListMapper.getEventList(paramMap);

        int count = eventListMapper.getEventListCount(paramMap);
        int totalPages = (int) Math.ceil((double) count / pageSize);

        // Add results to the resultMap
        resultMap.put("eventList", resultList);
    ...
    public List<Map<String, Object>> getEventListExcel(Map<String, Object> paramMap) {
        return eventListMapper.getEventListExcel(paramMap);
    }
}
