...
export interface SearchParams {
  ...
  device_type: string;
  fault_from_date: string;
  fault_to_date: string;
}

export const FaultListSearchArea = ({
  onSearch,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedSearchParams: SearchParams = {
      ...
      fault_from_date: startDate || '',
      fault_to_date: endDate || '',
    };
...
export default FaultListSearchArea;
