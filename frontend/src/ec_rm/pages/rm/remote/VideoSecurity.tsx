...
// 테스트 데이터
const fireSafetyTestData: VideoSecurityInfo[] = [
  {
    number: 10,
...
export const VideoSecurity = (): JSX.Element => {
  const [fireSafetyInfos, setFireSafetyInfos] =
    useState<VideoSecurityInfo[]>(fireSafetyTestData);
  const [selectedFireSafety, setSelectedFireSafety] =
    useState<VideoSecurityInfo>();
